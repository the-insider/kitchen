...
puts "Creating sample restaurants and menus..."
...
puts "Created #{Restaurant.count} restaurants with #{Menu.count} total menu items!"
puts "\nRestaurants:"
Restaurant.all.each do |restaurant|
  puts "  - #{restaurant.name} (#{restaurant.location}) - #{restaurant.menus.count} menu items"
end
